...
const Header = () => {
  return (
    <section className="px-6 py-2 md:px-14 ">
        ...
        <div className="flex mt-5 min-[576px]:mt-0  items-center justify-end">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              name="search"
              className="w-full pl-10 min-[576px]:pl-14  border focus-visible:outline-[#040440] border-[#040440] rounded-lg p-3 text-xs md:text-sm"
              placeholder="Search..."
            />
          </div>
        </div>
